...
export declare class AxelarQueryAPI {
     ...
     * @returns
     */
    estimateGasFee(sourceChainId: EvmChain | string, destinationChainId: EvmChain | string, sourceChainTokenSymbol: GasToken | string, gasLimit?: BigNumberish, gasMultiplier?: number, minGasPrice?: string, gmpParams?: GMPParams): Promise<string | AxelarQueryAPIFeeResponse>;
    /**
