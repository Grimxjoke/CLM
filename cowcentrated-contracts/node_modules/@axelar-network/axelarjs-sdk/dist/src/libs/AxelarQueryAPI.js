...
class AxelarQueryAPI {
     ...
     * @returns
     */
    estimateGasFee(sourceChainId, destinationChainId, sourceChainTokenSymbol, gasLimit = constants_2.DEFAULT_ESTIMATED_GAS, gasMultiplier = 1.1, minGasPrice = "0", gmpParams) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, utils_2.throwIfInvalidChainIds)([sourceChainId, destinationChainId], this.environment);
