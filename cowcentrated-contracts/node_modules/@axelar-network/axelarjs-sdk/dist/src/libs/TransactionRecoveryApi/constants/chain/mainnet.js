...
exports.rpcMap = {
    ...
    [EvmChain_1.EvmChain.ETHEREUM]: "https://mainnet.infura.io/v3/510b6d5b3c56497b8070626a54f565a9",
    [EvmChain_1.EvmChain.AURORA]: "https://mainnet.aurora.dev",
    [EvmChain_1.EvmChain.BINANCE]: "https://bsc-dataseed.binance.org",
    [EvmChain_1.EvmChain.BNBCHAIN]: "https://bsc-dataseed.binance.org",
    ...
    [EvmChain_1.EvmChain.FILECOIN]: "https://rpc.ankr.com/filecoin",
...
exports.networkInfo = {
    ...
    [EvmChain_1.EvmChain.BNBCHAIN]: {
        chainId: 56,
        name: EvmChain_1.EvmChain.BNBCHAIN,
    },
