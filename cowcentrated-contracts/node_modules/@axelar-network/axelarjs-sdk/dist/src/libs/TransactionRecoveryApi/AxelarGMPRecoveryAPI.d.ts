...
export declare class AxelarGMPRecoveryAPI extends AxelarRecoveryApi {
    ...
    doesTxMeetConfirmHt(chain: string, txHash: string): Promise<boolean | undefined>;
    ...
    getEvmEvent(srcChainId: string, destChainId: string, srcTxHash: string, srcTxEventIndex: number | undefined): Promise<{
        commandId: string;
        eventResponse: EventResponse;
        success: boolean;
        errorMessage: string;
    ...
    getEventIndex(chain: string, txHash: string): Promise<Nullable<number>>;
    addGasToCosmosChain({ autocalculateGasOptions, sendOptions, ...params }: AddGasParams): Promise<AddGasResponse>;
    /**
