...
class AxelarGMPRecoveryAPI extends AxelarRecoveryApi_1.AxelarRecoveryApi {
    ...
    getEvmEvent(srcChainId, destChainId, srcTxHash, srcTxEventIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            const eventIndex = srcTxEventIndex !== null && srcTxEventIndex !== void 0 ? srcTxEventIndex : (yield this.getEventIndex(srcChainId, srcTxHash)
                .then((index) => index)
                .catch(() => -1));
            if (eventIndex === -1) {
                return {
    ...
    findEventAndConfirmIfNeeded(srcChain, destChain, txHash, txEventIndex, evmWalletDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isEVMEventCompleted(evmEvent.eventResponse) ||
                ...
                const updatedEvent = yield this.getEvmEvent(srcChain, destChain, txHash, txEventIndex);
    ...
    manualRelayToDestChain(txHash, txLogIndex, txEventIndex, evmWalletDetails, escapeAfterConfirm = true, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    recoverEvmToCosmosTx(srcChain, txHash, txEventIndex) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    recoverEvmToEvmTx(srcChain, destChain, txHash, txEventIndex, evmWalletDetails, escapeAfterConfirm = true) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // ConfirmGatewayTx and check if it is successfully executed
    ...
    addGasToCosmosChain(_a) {
        ...
        var { autocalculateGasOptions, sendOptions } = _a, params = __rest(_a, ["autocalculateGasOptions", "sendOptions"]);
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const denomOnSrcChain = getIBCDenomOnSrcChain((_c = (_b = tx.gas_paid) === null || _b === void 0 ? void 0 : _b.returnValues) === null || _c === void 0 ? void 0 : _c.denom, chainConfig, chainConfigs);
          ...
          used for gas payment. Please send ${(_e = (_d = tx.gas_paid) === null || _d === void 0 ? void 0 : _d.returnValues) === null || _e === void 0 ? void 0 : _e.denom} instead`,
                };
            }
            const coin = params.token !== "autocalculate"
                ...
                : {
                    ...
                    amount: yield this.axelarQueryApi.estimateGasFee(tx.call.chain, tx.call.returnValues.destinationChain, (_h = (_g = (_f = tx.gas_paid) === null || _f === void 0 ? void 0 : _f.returnValues) === null || _g === void 0 ? void 0 : _g.denom) !== null && _h !== void 0 ? _h : "uaxl", autocalculateGasOptions === null || autocalculateGasOptions === void 0 ? void 0 : autocalculateGasOptions.gasLimit, autocalculateGasOptions === null || autocalculateGasOptions === void 0 ? void 0 : autocalculateGasOptions.gasMultipler),
                };
            ...
            const rpcUrl = (_j = sendOptions.rpcUrl) !== null && _j !== void 0 ? _j : rpc[0];
            if (!rpcUrl) {
                return {
                    success: false,
            ...
            const broadcastResult = yield signer.signAndBroadcast(sender, [
                {
                    ...
                    value: {
                        ...
                        timeoutTimestamp: (_k = sendOptions.timeoutTimestamp) !== null && _k !== void 0 ? _k : (Date.now() + 90) * 1e9,
                        memo: tx.call.id,
                    },
                },
            ], sendOptions.txFee);
    ...
    addNativeGas(chain, txHash, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gasToken = constants_1.nativeGasTokenSymbol[this.environment][chain];
            ...
            if (!gasFeeToAdd) {
                gasFeeToAdd = yield this.calculateNativeGasFee(txHash, chain, destinationChain, gasToken, {
