...
var _tokens = {
    ...
    WBTC: __assign(__assign({}, BTC), { symbol: 'fmcWBTC', website: 'https://wbtc.network/', bridge: 'multichain', description: 'Wrapped Bitcoin (WBTC) is the first ERC20 token backed 1:1 with Bitcoin. Completely transparent. 100% verifiable. Community led.' }),
    BTC: BTC,
    AAVE: {
        name: 'Aave',
    ...
    lzUSDT: {
        ...
        bridge: 'layer-zero',
        description: 'USDT is a cryptocurrency that is designed to maintain a stable value equivalent to the US dollar by being backed by a one-to-one reserve ratio of fiat currency held in deposit by Tether Limited.',
        documentation: 'https://layerzero.gitbook.io/docs/',
    },
    lzWETH: {
        name: 'Wrapped Ether',
