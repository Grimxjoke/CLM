...
var chainlink_1 = require("./platforms/chainlink");
...
var balancer_1 = require("./platforms/balancer");
var solace_1 = require("./platforms/solace");
var dystopia_1 = require("./platforms/dystopia");
var tokens_1 = require("./tokens/tokens");
var convertSymbolTokenMapToAddressTokenMap_1 = require("../../util/convertSymbolTokenMapToAddressTokenMap");
var _polygon = {
    platforms: __assign(__assign(__assign({ beefyfinance: beefyfinance_1.beefyfinance, chainlink: chainlink_1.chainlink, cometh: cometh_1.cometh, dfyn: dfyn_1.dfyn, polyzap: polyzap_1.polyzap, quickswap: quickswap_1.quickswap, sushi: sushi_1.sushi, wault: wault_1.wault, polycat: polycat_1.polycat, iron: iron_1.iron }, polyyeld), polypup), { apeswap: apeswap_1.apeswap, brainswap: brainswap_1.brainswap, mai: mai_1.default, jetswap: jetswap_1.default, farmhero: farmhero_1.farmhero, polywise: polywise_1.polywise, polysage: polysage_1.polysage, balancer: balancer_1.balancer, solace: solace_1.solace, dystopia: dystopia_1.dystopia }),
    tokens: tokens_1.tokens,
    tokenAddressMap: (0, convertSymbolTokenMapToAddressTokenMap_1.convertSymbolTokenMapToAddressTokenMap)(tokens_1.tokens),
};
